const t=new CSSStyleSheet;t.replaceSync(`
  ...
  * {
  ...
  `);class e extends HTMLElement{static modalIdCounter=0;constructor(){super(),e.modalIdCounter+=1,this.modalIdCounter=e.modalIdCounter,this.modalElement=null,this.modalButtonElement=null;let o=this.attachShadow({mode:"open"}),a=document.createElement("style");a.textContent=t.cssRules?Array.from(t.cssRules).map(t=>t.cssText).join(""):"",o.innerHTML=`
    <style>
    </style>
...
//# sourceMappingURL=index.5427ce1d.js.map
