const o=new CSSStyleSheet;o.replaceSync(`
  ...
  * {
  ...
  `);class t extends HTMLElement{static accordionIdCounter=0;constructor(){super(),t.accordionIdCounter+=1,this.accordionIdCounter=t.accordionIdCounter,this.accordionElement=null;let e=this.attachShadow({mode:"open"}),a=document.createElement("style");a.textContent=o.cssRules?Array.from(o.cssRules).map(o=>o.cssText).join(""):"",e.innerHTML=`
