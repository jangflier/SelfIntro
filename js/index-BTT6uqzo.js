var T=Object.defineProperty;var O=(o,t,a)=>t in o?T(o,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):o[t]=a;var E=(o,t,a)=>O(o,typeof t!="symbol"?t+"":t,a);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))e(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&e(s)}).observe(document,{childList:!0,subtree:!0});function a(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function e(n){if(n.ep)return;n.ep=!0;const i=a(n);fetch(n.href,i)}})();const u={LOADING_SCREEN_DELAY:1e3,TYPE_TEXT_DELAY:70,OFFSET_PERCENTAGE20:.2,OFFSET_PERCENTAGE70:.7,OFFSET_PERCENTAGE80:.8},v={checkTheme(o){const t=o.matches?"dark":"light";console.log(`Your system theme is ${t}!`)},async typeText(o,t,a){let e=o;for(let n=0;n<t.length;n++){await new Promise(s=>setTimeout(s,a));let i=t[n];if(i==="["){const s=document.createElement("strong");e=o.appendChild(s),i=""}else i==="]"?(e=o,i=""):i==="~"&&(i="🎶");e.innerHTML+=i}},checkScrollOffsetReached(o,t,a){const e=window.innerHeight*a,n=o.offsetTop,i=o.offsetHeight;return t>=n-e&&t<n+i-e},toggleActiveState(o={},t={},a=0){const e=window.scrollY,n=this.checkScrollOffsetReached(o,e,u.OFFSET_PERCENTAGE20);if(t.asideLinks[a].classList.toggle("active",n),n){if(a===0){const s=o.getElementsByClassName("intro-text");Array.from(s)[1].style.transform=`translateX(${e}px)`,Array.from(s)[2].style.transform=`translateX(-${e}px)`,o.style.animationPlayState="running"}}else o.style.animationPlayState="paused";if(!(!Object.values(t.isFadeInOnce).some(s=>s===!1)||!this.checkScrollOffsetReached(o,e,u.OFFSET_PERCENTAGE70))){if(!t.isFadeInOnce.about&&a===1){const s=Array.from(o.querySelectorAll(".profile-text > p")),h=o.querySelector(".profile-photo");h.style.animation="1s slideUp ease-in-out forwards",s.forEach((b,k)=>{b.style.animation=`1s slideRight ${k*.5}s ease-in-out forwards`});const l=o.querySelector(".about-category");l.style.pointerEvents="none",l.addEventListener("animationend",function b(k){l.style.pointerEvents="auto";const y=0;t.tablinks.tablinks[y].classList.add("active"),t.tablinks.tabcontents[y].classList.add("active"),t.tablinks.tabcontents[y].style.maxHeight=t.tablinks.tabcontents[y].scrollHeight+"px",t.isFadeInOnce.about=!0,l.removeEventListener("animationend",b)}),this.checkScrollOffsetReached(l,e,u.OFFSET_PERCENTAGE80)&&(l.style.animation="0.5s slideDown ease-in-out forwards")}!t.isFadeInOnce.experience&&a===2&&(Array.from(o.querySelectorAll("accordion-component")).forEach(s=>{s.animateFadeIn()}),t.isFadeInOnce.experience=!0),!t.isFadeInOnce.projects&&a===3&&(Array.from(o.querySelectorAll("modal-component")).forEach(s=>{s.animateFadeIn()}),t.isFadeInOnce.projects=!0),!t.isFadeInOnce.contact&&a===4&&(Array.from(o.querySelectorAll("#contact > article > nav > ul > li")).forEach((s,h)=>{s.style.animation=`1s ${h%2===0?"slideRight":"slideLeft"} ${h*.5}s ease-in-out forwards`}),t.isFadeInOnce.contact=!0)}}},C=window.matchMedia("(prefers-color-scheme: dark)");C.addEventListener("change",v.checkTheme);v.checkTheme(C);const F=document.getElementsByTagName("html")[0],x=document.getElementById("loading-screen"),d=document.getElementsByTagName("aside")[0],c=document.getElementsByClassName("intro-text");window.onload=async function(){let o=performance.getEntriesByType("navigation")[0];o.loadEventEnd-o.startTime,console.log("Loading complete!");const t="I'm [Yunseok Jang]~",a="Full Stack Engineer.";async function e(n,i){c[i].style.animation="fadeIn 1s ease-in-out",c[i].style.setProperty("--intro-text-content","'|'"),await v.typeText(c[i],n,u.TYPE_TEXT_DELAY),i===2?c[i].style.setProperty("--cursor-animation","blinkTypingCursor 1s step-end infinite"):c[i].style.setProperty("--intro-text-content","''")}setTimeout(async()=>{x.style.display="none",await e(t,1),await e(a,2)},[u.LOADING_SCREEN_DELAY]),x.style.opacity=0,F.style.overflowY="auto",d.style.animation="slideLeft 1.5s ease-in-out",c[0].style.animation="slideUp 1s ease-in-out"};const B=document.querySelectorAll("main > section"),N=Array.from(document.getElementsByClassName("link")),g=Array.from(document.getElementsByClassName("tablink")),w=Array.from(document.getElementsByClassName("tabcontent")),q={about:!1,experience:!1,projects:!1,contact:!1};let m="",A=()=>{};window.addEventListener("scroll",function(){B.forEach((o,t)=>{v.toggleActiveState(o,{asideLinks:N,tablinks:{tablinks:g,tabcontents:w},isFadeInOnce:q},t)})});g.forEach(o=>{o.addEventListener("click",t=>{t.target.classList.contains("active")||(clearTimeout(A),g.forEach(e=>{e.classList.toggle("active",e.getAttribute("name")===t.target.name)}),m===t.target.name?(w.forEach(e=>{e.getAttribute("name")===m?(e.classList.add("active"),e.style.maxHeight=`${e.scrollHeight}px`):e.classList.remove("active")}),m=""):w.forEach(e=>{const n=e.getAttribute("name");e.classList.contains("active")&&(e.classList.remove("active"),m=n,e.style.maxHeight="0"),n===t.target.name&&(e.classList.add("active"),A=setTimeout(()=>{m="",e.style.maxHeight=`${e.scrollHeight}px`},500))}))})});const p=document.getElementById("nav-aside-button");window.addEventListener("click",o=>{!d.querySelector("#nav-aside-container").contains(o.target)&&!d.querySelector("#nav-aside-button").contains(o.target)&&(p.classList.remove("active"),d.style.width="0")});p.addEventListener("click",o=>{p.classList.contains("active")?d.style.width="0":d.style.width="100%",p.classList.toggle("active")});const P=Array.from(document.getElementsByClassName("logo"));P.forEach(o=>{o.addEventListener("mousemove",t=>{const{width:a,height:e}=t.target.getBoundingClientRect();o.style=`transform: perspective(200px) rotateX(${Math.round(-40/e*t.offsetY+20)}deg) rotateY(${Math.round(40/a*t.offsetX-20)}deg)`}),o.addEventListener("mouseout",t=>{t.target.style="transform: rotate(0)"})});const I=new CSSStyleSheet;I.replaceSync(`
  :host {
  ...
  * {
  ...
  `);const r=class r extends HTMLElement{constructor(){super(),r.accordionIdCounter+=1,this.accordionIdCounter=r.accordionIdCounter,this.accordionElement=null;const t=this.attachShadow({mode:"open"});this.shadowRoot.adoptedStyleSheets=[I],t.innerHTML=`
    <style>
    </style>
