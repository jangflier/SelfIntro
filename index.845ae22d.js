class t extends HTMLElement{static sharedStyles=(()=>{let t=new CSSStyleSheet;return t.replaceSync(`
    :host {
  ...
  `),t})();constructor(){super(),this.modalIdCounter=t.incrementCounter(),this.modalElement=null,this.modalButtonElement=null;let e=this.attachShadow({mode:"open"});e.adoptedStyleSheets=[t.sharedStyles],e.innerHTML=`
